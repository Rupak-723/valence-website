          ...
          >
            <div className="flex min-h-screen items-start justify-center px-6 py-10">
              ...
              <motion.div
                ...
                className="relative w-full max-w-3xl overflow-hidden rounded-3xl border border-white/10 bg-slate-900/90 shadow-2xl shadow-cyan-500/20"
              >
                ...
                <div className="relative p-10">
                  ...
                  <div className="mt-8 flex flex-wrap gap-4">
                    ...
                    <motion.a
                      ...
                      className="flex items-center gap-2 rounded-full border border-cyan-500/40 px-8 py-3 font-semibold text-cyan-300 transition hover:bg-cyan-500/10"
                    >
